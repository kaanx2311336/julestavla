`README.md`, TavlaJules projesinin ilk kurulum ve build notlarini tutar.

- `dotnet run` ile calistirma komutunu verir.
- `dotnet publish` ile tek dosyali Windows EXE uretme komutunu verir.
